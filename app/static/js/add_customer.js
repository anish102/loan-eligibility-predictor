...
document.getElementById("add-customer-form").addEventListener("submit", async function (event) {
  ...
  const customerData = {
    ...
    residential_assets: parseFloat(document.getElementById("residential_assets").value) || 0,
    commercial_assets: parseFloat(document.getElementById("commercial_assets").value) || 0,
    luxury_assets: parseFloat(document.getElementById("luxury_assets").value) || 0,
    bank_assets: parseFloat(document.getElementById("bank_assets").value) || 0,
